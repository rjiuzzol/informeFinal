...
\subsection{Introducción general} % FINES ORGANIZATIVOS. BORRAR ESTA LINEA AL FINAL
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figuras/intro/curvaIV1Juntura.png}
...
%Para esto, es necesario que la señal que se quiera generar tenga frecuencias bajas con respecto a la señal del tren de pulsos. 
%Esto se precisa con el parámetro de sobremuestreo, OSR (Oversampling ratio), definido
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figuras/experimental/esquemaJAWS.png}
